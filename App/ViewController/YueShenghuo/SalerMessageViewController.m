...
@interface SalerMessageViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SalerMessageViewController
...
- (void)prepareScollView {
    ...
    firstImage.image = [UIImage imageNamed:@"商家快讯"];
    ...
    lastImage.image = [UIImage imageNamed:@"商家快讯"];
